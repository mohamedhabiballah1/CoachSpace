    ...
    <div className="min-h-screen bg-[#0e0e0e] flex flex-col">
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full px-6 py-8">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="font-['Bebas_Neue'] text-[40px] text-[#f0ede6] leading-none">Clients</h1>
            <p className="text-[#555] text-[13px] font-['DM_Mono'] mt-1">{clients.length} total</p>
          </div>
          <button onClick={() => setIsAddOpen(true)}
            className="font-['Bebas_Neue'] text-[18px] tracking-[0.04em] px-5 py-2.5 rounded-[4px] bg-[#c8f135] text-[#0e0e0e] hover:opacity-90 transition-opacity">
            + New Client
          </button>
        </div>
        ...
        <div className="flex flex-wrap gap-3 mb-6">
          <input
            ...
            className="bg-[#161616] border border-[#2a2a2a] text-[#f0ede6] font-['DM_Sans'] text-[13px] px-3 py-2 rounded-[4px] outline-none focus:border-[#383838] placeholder-[#555] w-64"
          />
          <div className="flex gap-1">
            {GOAL_FILTERS.map(g => (
              <button key={g} onClick={() => setGoalFilter(g)}
                className={`font-['DM_Mono'] text-[11px] uppercase tracking-[0.06em] px-3 py-2 rounded-[4px] transition-colors border ${
                  goalFilter === g
          ...
          <select value={sortBy} onChange={e => setSortBy(e.target.value)}
            className="bg-[#161616] border border-[#2a2a2a] text-[#555] font-['DM_Mono'] text-[11px] px-3 py-2 rounded-[4px] outline-none">
                  ...
                  >
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-full bg-[#1f1f1f] border border-[#383838] flex items-center justify-center font-['DM_Mono'] text-[11px] text-[#888] flex-shrink-0">
